      ...
      <div className="flex flex-wrap justify-center gap-6 text-left">
        {plans.map((item, index) => (
          ...
          >
            ...
            <button className=" cursor-pointer w-full bg-gray-800 text-white mt-8 text-sm rounded-md py-2.5 min-w-52 hover:bg-blue-800 scale-105 transition-all duration-500">
              Buy Now
            </button>
          </div>
        ))}
